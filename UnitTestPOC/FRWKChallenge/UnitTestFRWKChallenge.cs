...
namespace UnitTestPOC
{
    ...
    public class UnitTestFRWKChallenge
    {
        ...
        public void TestUtilitesDecomposeNumber_Performance()
        {
            ...
            sw.Start();
            obj = NumericalOperations.DecomposeNumberMethod1(720);
            sw.Stop();
            var time1 = sw.Elapsed;

            sw.Reset();
            sw.Start();
            obj = NumericalOperations.DecomposeNumberMethod2(720);
            sw.Stop();
        ...
        {
            FRWKChallenge obj = NumericalOperations.DecomposeNumberMethod1(720);
            FRWKChallenge obj2 = NumericalOperations.DecomposeNumberMethod2(720);
        ...
        {
            FRWKChallenge obj = NumericalOperations.DecomposeNumberMethod2(-14);
        }

        [TestMethod]
        public void TestUtilitesDecomposeNumber_ValidNumber_ResultInstanceOf()
        {
            FRWKChallenge obj = NumericalOperations.DecomposeNumberMethod2(720);
